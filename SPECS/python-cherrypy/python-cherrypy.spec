...
# supress depracation warning in pytest.ini
...
# for the future update of this package, cherrypy might stop using pkg_resources.declare_namespace.
# Might be ok to delete this in the future when that happens.
sed '/filterwarnings =/a \    \ignore::DeprecationWarning' pytest.ini
...
%changelog
* Wed Mar 08 2023 Riken Maharjan <mwani@microsoft.com> - 18.6.1-3
- Supress depraction warning so that tests don't fail
